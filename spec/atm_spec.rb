...
RSpec.describe Atm do
  ...
  describe 'user has enough funds to withdraw money' do
    ...
    it 'is expected to allow withdrawal if account has enough balance' do
      ...
      expect(
        subject.withdraw(45, '1234', account, :active),
  ...
  describe 'user is rejected a withdrawal' do
    ...
    it 'is expected to reject a withdraw' do
      ...
      expect(
        subject.withdraw(105, '1234', account, :active),
      ).to eq expected_output
    end
    ...
    it 'is expected to reject withdraw if ATM has insufficient funds' do
      ...
      expect(
        subject.withdraw(100, '1234', account, :active),
      ).to eq expected_output
    end
    ...
    it 'is expected to reject withdraw if the card is expired' do
      ...
      expect(
        subject.withdraw(6, '1234', account, :active),
      ).to eq expected_output
    end
    ...
    it 'is expected to reject withdraw if the account is disabled' do
      ...
      expect(
        subject.withdraw(45, '1234', account, :disabled),
      ).to eq expected_output
    end
  end
end
